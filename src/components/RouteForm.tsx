      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col gap-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all resize-none dark:text-zinc-100"
        ...
        <div>
          ...
          >
            ...
            <option value="Autobús">Camión</option>
          </select>
        </div>
