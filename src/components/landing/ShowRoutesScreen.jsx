...
const videoSrc = '/via.mp4';
  
gsap.registerPlugin(ScrollTrigger);

export function ShowRoutesScreen() {
  ...
  return (
    <section ref={sectionRef} className="screen-section">
      ...
      <div className="screen-glass-panel" style={isMobile ? { flexDirection: 'column-reverse' } : {}}>
              ...
              >
                ...
                >
                  ...
                  <p style={{ 
                    ...
                    Descubre al instante todas las rutas a tu alrededor. Mantén el control de tu entorno con información en vivo, directamente en la palma de tu mano.
                  </p>
                </div>
              </div>
            )}
